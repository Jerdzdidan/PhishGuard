<div class="col-sm-6 col-lg-4">
    ...
    <div class="card-body p-4 pt-2">
        ...
        <a class="w-100 btn btn-primary d-flex align-items-center" href="{{ $route }}"> <i class="icon-base bx bx-edit icon-sm align-middle scaleX-n1-rtl me-2"></i><span>Edit</span></a>
        </div>
    </div>
    </div>
</div>